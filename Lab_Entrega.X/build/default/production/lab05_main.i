...
config_int_enable:; INTCON
    bsf ((INTCON) and 07Fh), 7 ; banderas globales
    bsf ((INTCON) and 07Fh), 3 ; habilitar banderas de interrupción puertos B
    bcf ((INTCON) and 07Fh), 0
    bsf ((INTCON) and 07Fh), 5 ; habilitar banderas de interrupción tmr0
    bcf ((INTCON) and 07Fh), 2
